            ...
            for potential_vehicle in potential_vehicles:
                ...
                if potential_vehicle.get('valid_plate'):
                    ...
                    if plate_lookup.get('violations'):
                        ...
                        response_parts.append(["{} Sorry, I received an error when looking up {}:{}{}. Please try again.".format(username, plate_lookup.get('state').upper(), plate_lookup.get('plate').upper(), (' (types: ' + potential_vehicle.get('types') + ')') if potential_vehicle.get('types') else '')])
                        ...
                        response_parts.append(["{} Sorry, I couldn't find any tickets for {}:{}{}.".format(username, potential_vehicle.get('state').upper(), potential_vehicle.get('plate').upper(), (' (types: ' + potential_vehicle.get('types') + ')') if potential_vehicle.get('types') else '',  )])
