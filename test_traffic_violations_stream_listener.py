...
from traffic_violations_stream_listener import TrafficViolationsStreamListener
...
class TestTrafficViolationsStreamListener(unittest.TestCase):
    ...
    def setUp(self):
        self.listener = TrafficViolationsStreamListener(TrafficViolationsTweeter())
    ...
    def test_on_data(self):
        ...
        self.listener.tweeter.aggregator.initiate_reply.assert_called_with(123, 'direct_message')
        ...
        self.listener.tweeter.aggregator.initiate_reply.assert_called_with(123, 'status')
